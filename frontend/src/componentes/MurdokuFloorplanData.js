...
export const MULTI_BLOCK_GRID = [
  ...
  // Row 1
  { row: 1, col: 0, zone: 'cocina', zoneTitle: 'ZONA COCINA', obstacle: null, isBlocked: false },
  { row: 1, col: 1, zone: 'sofa', obstacle: null, isBlocked: false },
  { row: 1, col: 2, zone: 'sofa', obstacle: '📺 TV', isBlocked: true },
  { row: 1, col: 3, zone: 'bano', zoneTitle: 'BAÑO / ASEO', obstacle: null, isBlocked: false },
  ...
  { row: 2, col: 1, zone: 'sofa', zoneTitle: 'SALÓN / SOFÁ', obstacle: null, isBlocked: false },
